...
/**
 * Used to wrap [CordaNodesProperties] for easier parsing via jackson-dataformats-text,
 * as a temporary workaround to https://github.com/FasterXML/jackson-dataformats-text/issues/100
 */
class CordaNodesPropertiesWrapper {
    var corbeans: CordaNodesProperties? = null
}
